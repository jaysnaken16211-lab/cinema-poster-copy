...
function movieFromRaw(raw, refs, posterPath = "api") {
  ...
  const directorLang = parseMaybeJson(raw.director_lang);
  const castLang = parseMaybeJson(raw.cast_lang);
  ...
  return {
    ...
    directorZh: cleanCredit(directorLang.zh_hk || raw.director || ""),
    directorEn: cleanCredit(directorLang.en || raw.director || ""),
    castZh: cleanCredit(castLang.zh_hk || raw.cast || ""),
    castEn: cleanCredit(castLang.en || raw.cast || ""),
    posterFile,
